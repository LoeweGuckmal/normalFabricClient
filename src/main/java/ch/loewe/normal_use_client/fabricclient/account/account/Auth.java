 ...
 */
public class Auth {
    private static final String CLIENT_ID = "55fca734-6e47-4719-ac3f-1fcdc5600732";
    ...
    public static Map.@NotNull Entry<@NotNull String, @NotNull String> codeToToken(@NotNull String code) throws Exception {
        ...
        try (OutputStream out = conn.getOutputStream()) {
            out.write(("client_id=" + URLEncoder.encode(CLIENT_ID, StandardCharsets.UTF_8) + "&" +
                    ...
                    "client_secret=" + URLEncoder.encode("7O_8Q~0OGyKOQZwV9eEXOJj8IT6jUd_Vvw~VMcTi", StandardCharsets.UTF_8) + "&" +
